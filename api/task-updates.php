...
function changeHeadline(array $changes,$custom): string {
    ...
    $names=['project_id'=>'โปรเจกต์','title'=>'ชื่องาน','feature'=>'ฟังก์ชัน','kind'=>'ประเภทงาน','size'=>'ขนาดงาน','public_summary'=>'สรุป','scope'=>'รายละเอียด','criteria'=>'เกณฑ์ตรวจรับ','evidence'=>'หลักฐาน','assignee'=>'ผู้รับผิดชอบ','developer_ids'=>'ผู้พัฒนา','blocked_reason'=>'สาเหตุที่ติดขัด','checklist'=>'งานย่อย','planned_go_live_on'=>'กำหนดเริ่มใช้'];
    $parts=[];
