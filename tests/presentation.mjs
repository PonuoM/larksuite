...
try {
 execFileSync('node',['node_modules/typescript/bin/tsc','--ignoreConfig','src/FormattedReport.tsx','src/ProjectViews.tsx','src/MeetingCalendar.tsx','--jsx','react-jsx','--module','ESNext','--target','ES2022','--moduleResolution','bundler','--esModuleInterop','--skipLibCheck','--outDir',temp],{cwd:root,windowsHide:true});
